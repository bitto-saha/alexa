...
recognition.onresult = function(event){
  ...
  //initializing audio playlist
    ...
    audio = new Audio('/songs/KAUN_TUJHE.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Khairiyat.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Ae_Watan_.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Bangladesh_National.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Enna_Sona.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Hamari_Adhuri_Kahani.mp3');
    audio.play();
  
  }
  
  
  else if (content.textContent.toLocaleLowerCase().includes("chor") && content.textContent.toLocaleLowerCase().includes("denge")) {
  
    read("playing your song!");
    audio = new Audio('/songs/Chhor_Denge.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/SANAM_RE_Song_(VIDEO)_|_Pulkit_Samrat,_Yami_Gautam,_Urvashi_Rautela,_Divya_Khosla_Kumar_|_T-Series(256k).mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Teri_Mitti_-_Lyrical___Kesari___Akshay_Kumar_&_Parineeti_Chopra___Arko___B_P.mp3');
    audio.play();
  
  }
  
  else if (content.textContent.toLocaleLowerCase().includes("lute") && content.textContent.toLocaleLowerCase().includes("gaye")) {
  
    read("playing your song!");
    audio = new Audio('/songs/Teri_Nazron_Ne_Kuch_Aisa_Jadoo_Kiya_(Official_Video)_Jubin_Nautiyal_Ft._Emra.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Namo_Namo_-_Lyrical___Kedarnath___Sushant_Rajput___Sara_Ali_Khan___Amit_Triv.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Abhi_Tumhe_Aur.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Shiv_Tandav.mp3');
    audio.play();
  ...
  else if (content.textContent.toLocaleLowerCase().includes("ve") && content.textContent.toLocaleLowerCase().includes("maahi")) {
  
    read("playing your song!");
    audio = new Audio('/songs/Ve_Maahi___Kesari___Akshay_Kumar_&_Parineeti_Chopra___Arijit_Singh___Tanishk.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Funny_Hindi.mp3');
    audio.play();
  
  }
  
  else if (content.textContent.toLocaleLowerCase().includes("phir") && content.textContent.toLocaleLowerCase().includes("vhi")) {
  
    read("playing your song!");
    audio = new Audio('/songs/Phir_Bhi_Tumko_Chaahunga_-_Full_Song___Arijit_Singh___Arjun_K_&_Shraddha_K__.mp3');
    audio.play();
    ...
    read("playing your song!");
    audio = new Audio('/songs/Rehna_Tu_Pal_Pal_Dil_Ke_Paas_Full_Song__(Lyrics)_▪_Arijit_Singh_&_Parampara_Thakur_▪_Karan_Deol(128k).mp3');
    audio.play();
